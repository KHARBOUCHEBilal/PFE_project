...
@section('content')
    <div class="page" id="page">
        <div class=new-admin id="new-admin">
            <div class="page-top">
                <div class="title">{{ __('pages/admin/global.edit') }}{{ __('pages/admin/global.category') }}</div>
            ...
            <div class="page-body" id="page-body">
                ...
                <div class="body-content" id="body-content">
                    <form class="form" action="{{ route('categories.update', $category->id) }}" method="POST">
                        ...
                        <div class="section">
                            <div class="title">{{ __('pages/admin/global.category_info') }}</div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="field">
                            ...
                            <div class="col-sm-12">
                                <div class="tags-field">
                                    ...
                                    @php $models_ids = explode(',', $category->model_id) @endphp
                                    <div class="tags">
                                        @foreach ($models as $model)
                                            <div class="tag  @if (in_array($model->id, $models_ids)) active @endif"
                                                id="tag">
                                                <label>{{ $model->name }}</label>
                                                <input type="checkbox" value="{{ $model->id }}" name="model_id[]"
                                                    @if (in_array($model->id, $models_ids)) checked @endif>
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
