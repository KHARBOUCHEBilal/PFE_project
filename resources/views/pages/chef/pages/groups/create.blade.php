        ...
        <div class=new-admin id="new-admin">
            ...
            <div class="page-body" id="page-body">
                ...
                <div class="body-content" id="body-content">
                    <form class="form" action="{{ route('groups.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="section">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="field">
                                    ...
                                    <select id="subject1_id" name="subject1_id" required>
                                        @if ($subjects->count() > 0)
                            ...
                            <div class="col-sm-12">
                                <div class="field">
                                    ...
                                    <div class="selectBox" onclick="showCheckboxes()">
                                        <select>
                                            <option>Select votre binome</option>
                                        </select>
                                    ...
                                    <div id="checkboxes">
                                        @foreach ($users as $user)
                                            <div class="tag" id="tag">
                                                <label>
                                                    <input type="checkbox" value="{{ $user->id }}" name="users_ids[]">
                            ...
                            <div class="col-sm-12">
                                <div class="field">
                                    ...
                                    <textarea name="motivation" id="editor" rows="12">{{ old('motivation') }}</textarea>
