                ...
                <div class="body-content" id="body-content">
                    <form class="form" action="{{ route('groups.update', $group->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="field">
                                    <label htmlFor="subject1_id">{{ __('pages/admin/global.category') }}</label>
                            ...
                            <div class="col-12">
                                <div class="field">
                                    <label htmlFor="subject2_id">{{ __('pages/admin/global.category') }}</label>
                            ...
                            <div class="col-12">
                                <div class="field">
                                    <label htmlFor="subject3_id">{{ __('pages/admin/global.category') }}</label>
