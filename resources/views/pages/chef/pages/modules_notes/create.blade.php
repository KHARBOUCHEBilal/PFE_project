        ...
        <div class=new-admin id="new-admin">
            <div class="page-top">
                ...
                <div class="other-page">
                    <a href="{{ route('modules_notes.index') }}">
                        <span>
            ...
            <div class="page-body" id="page-body">
                ...
                <div class="body-content" id="body-content">
                    <form class="form" action="{{ route('modules_notes.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="section">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="field">
                                    ...
                                    <input type="number" step=".01" min="0" max="20" name="programation2" id="programation2"
                                        value="{{ old('programation2') }}" />
                                    @if ($errors->has('programation2'))
                                        <span class="help-block">{!! $errors->first('programation2') !!}</span>
                                    @endif
                                </div>
                                <div class="field">
                                    <label htmlFor="structure_de_donnees">Structure de donnees</label>
                                    <input type="number" step=".01" min="0" max="20" name="structure_de_donnees" id="structure_de_donnees"
                                        value="{{ old('structure_de_donnees') }}" />
                                    @if ($errors->has('structure_de_donnees'))
                                        <span class="help-block">{!! $errors->first('structure_de_donnees') !!}</span>
                                    @endif
                                </div>
                                <div class="field">
                                    ...
                                    <input type="number" step=".01" min="0" max="20" name="systeme_dexploitation2" id="systeme_dexploitation2"
                                        value="{{ old('systeme_dexploitation2') }}" />
                                ...
                                <div class="field">
                                    ...
                                    <input type="number" step=".01" min="0" max="20" name="archetecture_des_ordinateurs" id="archetecture_des_ordinateurs"
                                        value="{{ old('archetecture_des_ordinateurs') }}" />
