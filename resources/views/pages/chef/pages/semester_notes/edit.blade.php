...
@section('content')
    <div class="page" id="page">
        <div class=new-admin id="new-admin">
            <div class="page-top">
                <div class="title">Modifiée les notes de semester</div>
                <div class="other-page">
                    <a href="{{ route('semester_notes.index') }}">
                        <span>
                            <i class="fa-solid fa-list-check"></i>Touts les semester
                        </span>
                    </a>
                </div>
            </div>
            <div class="page-body" id="page-body">
                ...
                <div class="body-content" id="body-content">
                    <form class="form" action="{{ route('semester_notes.update',$semester_note) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="section">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="field">
                                    ...
                                    <input type="number" step=".01" min="0" max="20" name="S1"
                                        id="S1" value="{{$semester_note->S1}}" />
                                    @if ($errors->has('S1'))
                                ...
                                <div class="field">
                                    ...
                                    <input type="number" step=".01" min="0" max="20" name="S2"
                                        id="S2" value="{{$semester_note->S2}}" />
                                    @if ($errors->has('S2'))
                                ...
                                <div class="field">
                                    ...
                                    <input type="number" step=".01" min="0" max="20" name="S3"
                                        id="S3" value="{{$semester_note->S3}}" />
                                    @if ($errors->has('S3'))
                                ...
                                <div class="field">
                                    ...
                                    <input type="number" step=".01" min="0" max="20" name="S4"
                                        id="S4" value="{{$semester_note->S4}}" />
                                    @if ($errors->has('S4'))
                                ...
                                <div class="field">
                                    ...
                                    <input type="number" step=".01" min="0" max="20" name="S5"
                                        id="S5" value="{{$semester_note->S5}}" />
                                    @if ($errors->has('S5'))
                                ...
                                <div class="field">
                                    ...
                                    <input type="number" step=".01" min="0" max="20" name="S6"
                                        id="S6" value="{{$semester_note->S6}}" />
                                    @if ($errors->has('S6'))
