...
@section('content')
    <div class="page" id="page">
        <div class=new-admin id="new-admin">
            <div class="page-top">
                <div class="title">Modifiée Etudiant</div>
                <div class="other-page">
                    <a href="{{ route('students.index') }}">
                        <span>
                            <i class="fa-solid fa-list-check"></i>Toutes les Etudiants
                        </span>
                    </a>
                </div>
            </div>
            <div class="page-body" id="page-body">
                ...
                <div class="body-content" id="body-content">
                    <form class="form" action="{{ route('students.update',$student) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="section">
                            <div class="title">Les information d'étudiant</div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="field">
                                    ...
                                    <input type="text" name="nom" id="nom" value="{{$student->nom}}" />
                                    @if ($errors->has('nom'))
                            ...
                            <div class="col-sm-12">
                                <div class="field">
                                    ...
                                    <input type="text" name="prenom" id="prenom" value="{{$student->prenom}}" />
                            ...
                            <div class="col-sm-12">
                                <div class="field">
                                    ...
                                    <input type="text" name="CNI" id="CNI" value="{{$student->CNI}}" />
                                    @if ($errors->has('CNI'))
                            ...
                            <div class="col-sm-12">
                                <div class="field">
                                    ...
                                    <input type="text" name="CNE" id="CNE" value="{{$student->CNE}}" />
                                    @if ($errors->has('CNE'))
