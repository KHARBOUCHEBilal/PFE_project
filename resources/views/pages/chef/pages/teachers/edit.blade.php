        ...
        <div class=new-admin id="new-admin">
            ...
            <div class="page-body" id="page-body">
                ...
                <div class="body-content" id="body-content">
                    <form class="form" action="{{ route('teachers.update',$teacher) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="field">
                                    ...
                                    <input type="text" name="nom" id="nom" value="{{$teacher->nom}}" />
                                    @if ($errors->has('nom'))
                            ...
                            <div class="col-sm-12">
                                <div class="field">
                                    ...
                                    <input type="text" name="prenom" id="prenom" value="{{$teacher->prenom}}" />
